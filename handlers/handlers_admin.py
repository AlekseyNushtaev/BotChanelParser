...
from ai_gen import post_gen, post_digest
...
@admin_router.callback_query(F.data.startswith("ai_generate:"))
...
@admin_router.callback_query(F.data.startswith("toggle_parse_"))
...
@admin_router.callback_query(F.data.startswith("edit_post_"))
...
@admin_router.message(EditPost.waiting_edit_text, F.text)
...
@admin_router.callback_query(F.data.startswith("add_digest:"))
...
@admin_router.callback_query(F.data.startswith("publish_"),
...
@admin_router.callback_query(F.data.startswith("confirm_publish:"))
...
@admin_router.callback_query(F.data == "cancel_publish")
...
@admin_router.callback_query(F.data == "do_digest")
async def do_digest_callback(callback: CallbackQuery):
    ...
    try:
        ...
        digest_text = digest_text.replace('<br>', '')
...
@admin_router.callback_query(F.data.startswith("toggle_digest_parse:"))
...
@admin_router.callback_query(F.data.startswith("edit_digest:"))
...
@admin_router.message(DigestStates.waiting_digest_edit, F.text)
...
@admin_router.callback_query(F.data.startswith("publish_digest:"))
...
@admin_router.callback_query(F.data.startswith("confirm_digest_publish:"))
...
@admin_router.callback_query(F.data == "cancel_digest_publish")
